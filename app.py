...
def waterpotability():
    if request.method == "POST":
        ...
        msg['From'] = 'uttamu8298@gmail.com'
        msg['To'] = 'uttamkumar1712@gmail.com'
        ...
        server.starttls()
        server.login('uttamu8298@gmail.com', 'uttam@8298')
        text = msg.as_string()
        server.sendmail('uttamu8298@gmail.com', 'uttamkumar1712@gmail.com', text)
        server.quit()
